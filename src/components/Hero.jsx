  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} block text-white `}>
            Hi,I am <span className="text-[#915eff]">Akib</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a MERN stack developer.I create <br /> user interfaces and web
            application
          </p>
        </div>
      </div>
